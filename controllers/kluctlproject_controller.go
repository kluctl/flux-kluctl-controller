...
// KluctlProjectReconciler reconciles a KluctlProject object
...
//+kubebuilder:rbac:groups=kluctl.io,resources=kluctlprojects/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the KluctlProject object against the actual cluster state, and then
...
func (r *KluctlProjectReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kluctliov1alpha1.KluctlProject{}).
		Complete(r)
}
