...
func (in *KluctlProjectStatus) DeepCopyInto(out *KluctlProjectStatus) {
	*out = *in
	...
	if in.Artifact != nil {
		...
		*out = new(v1beta2.Artifact)
		(*in).DeepCopyInto(*out)
	}
	if in.ArchiveInfo != nil {
		in, out := &in.ArchiveInfo, &out.ArchiveInfo
		*out = new(ArchiveInfo)
		(*in).DeepCopyInto(*out)
	}
}
