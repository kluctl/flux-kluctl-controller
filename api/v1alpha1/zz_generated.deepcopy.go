...
func (in *KluctlMultiDeploymentStatus) DeepCopyInto(out *KluctlMultiDeploymentStatus) {
	*out = *in
	...
	if in.Targets != nil {
		...
		*out = make([]KluctlMultiDeploymentTargetStatus, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KluctlMultiDeploymentTargetStatus) DeepCopyInto(out *KluctlMultiDeploymentTargetStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KluctlMultiDeploymentTargetStatus.
func (in *KluctlMultiDeploymentTargetStatus) DeepCopy() *KluctlMultiDeploymentTargetStatus {
	if in == nil {
		return nil
	}
	out := new(KluctlMultiDeploymentTargetStatus)
	in.DeepCopyInto(out)
	return out
}
